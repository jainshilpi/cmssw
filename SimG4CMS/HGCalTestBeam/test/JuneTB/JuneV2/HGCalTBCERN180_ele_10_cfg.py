...
process.VtxSmeared.MeanX  = -.051
process.VtxSmeared.SigmaX = .312
process.VtxSmeared.MeanY  = -.047
process.VtxSmeared.SigmaY = .318
...
process.g4SimHits.Watchers = cms.VPSet(cms.PSet(
		HGCPassive = cms.PSet(
			...
			#LVNames = cms.vstring('HGCalEE', 'HGCalBeam'),
...
process.HGCalTBAnalyzer.DoPassiveHE   = False
