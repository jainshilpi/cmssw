...
class EGRegressionModifier : public ModifyObjectValueBase {
public:
  ...
  EGRegressionModifier(const edm::ParameterSet& conf);
  ~EGRegressionModifier() override;
...
DEFINE_EDM_PLUGIN(ModifyObjectValueFactory,
		  EGRegressionModifier,
		  "EGRegressionModifier");

EGRegressionModifier::EGRegressionModifier(const edm::ParameterSet& conf) :
...
EGRegressionModifier::~EGRegressionModifier() {}

void EGRegressionModifier::setEvent(const edm::Event& evt) {
...
void EGRegressionModifier::setEventContent(const edm::EventSetup& evs) {
...
void EGRegressionModifier::setConsumes(edm::ConsumesCollector& sumes) {
...
void EGRegressionModifier::modifyObject(reco::GsfElectron& ele) const {
...
void EGRegressionModifier::modifyObject(pat::Electron& ele) const {
  modifyObject(static_cast<reco::GsfElectron&>(ele));
}

void EGRegressionModifier::modifyObject(reco::Photon& pho) const {
  // regression calculation needs no additional valuemaps
...
void EGRegressionModifier::modifyObject(pat::Photon& pho) const {
