...
process.generator = cms.EDProducer("GaussRandomPThetaGunProducer",
    ...
    PGunParameters = cms.PSet(
		...
		MeanP    = cms.double(150),
		SigmaP   = cms.double(1.5),
...
process.VtxSmeared.MeanX  = -.040
process.VtxSmeared.SigmaX = .182
process.VtxSmeared.MeanY  = -.002
process.VtxSmeared.SigmaY = .123
