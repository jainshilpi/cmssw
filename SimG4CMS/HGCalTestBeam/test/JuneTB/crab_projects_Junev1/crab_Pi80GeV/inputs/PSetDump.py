...
process.VtxSmeared = cms.EDProducer("GaussEvtVtxGenerator",
    MeanX = cms.double(-0.253),
    MeanY = cms.double(-0.646),
    MeanZ = cms.double(-800.0),
    SigmaX = cms.double(0.844),
    SigmaY = cms.double(0.732),
    SigmaZ = cms.double(0),
    TimeOffset = cms.double(0.0),
    readDB = cms.bool(False),
    src = cms.InputTag("generator","unsmeared")
...
process.g4SimHits = cms.EDProducer("OscarMTProducer",
    ...
    HGCSD = cms.PSet(
        ...
        RejectMouseBite = cms.bool(True),
        RotatedWafer = cms.bool(True),
...
process.HGCalTBCheckGunPostion = cms.EDFilter("HGCalTBCheckGunPostion",
    HepMCProductLabel = cms.InputTag("generatorSmeared"),
...
process.HGCalTBAnalyzer = cms.EDAnalyzer("HGCalTBAnalyzer",
    ...
    IDBeams = cms.vint32(
        ...
        1005, 1006, 1007, 1008, 1011, 
        1012, 1013, 1014, 2001, 2002, 
        2003, 2004, 2005
    ),
    ...
    UseBeam = cms.bool(True),
    UseEE = cms.bool(True),
    UseFH = cms.bool(False),
    ZFrontBH = cms.double(0),
    ZFrontEE = cms.double(1110.0),
    ZFrontFH = cms.double(1172.3)
)
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('101X_mcRun2_asymptotic_v5'),
...
process.gunfilter_step = cms.Path(process.generator+process.HGCalTBCheckGunPostion)


process.simulation_step = cms.Path(process.generator+process.psim)


process.analysis_step = cms.Path(process.generator+process.HGCalTBAnalyzer)
...
process.schedule = cms.Schedule(*[ process.generation_step, process.genfiltersummary_step, process.simulation_step, process.gunfilter_step, process.analysis_step, process.endjob_step ])
