...
#process.VtxSmeared.MinY = 12.37
#process.VtxSmeared.MaxY = 12.37

#process.VtxSmeared.MinY = -12.37
#process.VtxSmeared.MaxY = -12.37

#process.VtxSmeared.MinX = -10.7127
#process.VtxSmeared.MaxX = -10.7127
#process.VtxSmeared.MinY = -6.185
#process.VtxSmeared.MaxY = -6.185


process.VtxSmeared.MinX = -17.87
process.VtxSmeared.MaxX = 17.87
process.VtxSmeared.MinY =  -18.57
process.VtxSmeared.MaxY = 18.57

#process.VtxSmeared.MeanX  = -.323
#process.VtxSmeared.SigmaX = .664
#process.VtxSmeared.MeanY  = -.491
#process.VtxSmeared.SigmaY = .386
