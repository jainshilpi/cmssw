...
process.generator = cms.EDProducer("FlatRandomEThetaGunProducer",
    ...
    PGunParameters = cms.PSet(
        MinE = cms.double(79.99),
        MaxE = cms.double(80.01),
...
process.VtxSmeared.MeanX  = -.253
process.VtxSmeared.SigmaX = .844
process.VtxSmeared.MeanY  = -.646
process.VtxSmeared.SigmaY = .732
