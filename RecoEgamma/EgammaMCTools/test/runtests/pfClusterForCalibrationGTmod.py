...
process.GlobalTag.toGet.extend( cms.VPSet(
        cms.PSet(
            ...
            tag = cms.string('ecalPFClusterCor2018V1_EB_ZS_mean_25ns'),
            label = cms.untracked.string('ecalPFClusterCor2018V1_EB_ZS_mean_25ns'),
            connect = cms.string('frontier://FrontierProd/CMS_CONDITIONS')
            ),
        cms.PSet(
            record = cms.string('GBRDWrapperRcd'),
            tag = cms.string('ecalPFClusterCor2018V1_EB_Full_ptbin1_mean_25ns'),
            #label = cms.untracked.string('ecalPFClusterCor2018V1_EB_Full_ptbin1_mean_25ns'),
            connect = cms.string('frontier://FrontierProd/CMS_CONDITIONS')
            ),
        cms.PSet(
            record = cms.string('GBRDWrapperRcd'),
            #tag = cms.string('ecalPFClusterCor2018V1_EB_Full_ptbin2_mean_25ns'),
            tag = cms.string('ecalPFClusterCor2018test_EB_Full_ptbin2_mean_25ns'),
            #label = cms.untracked.string('ecalPFClusterCor2018V1_EB_Full_ptbin2_mean_25ns'),
            connect = cms.string('frontier://FrontierProd/CMS_CONDITIONS')
            ),
        cms.PSet(
            record = cms.string('GBRDWrapperRcd'),
            tag = cms.string('ecalPFClusterCor2018test_EB_Full_ptbin3_mean_25ns'),
            #label = cms.untracked.string('ecalPFClusterCor2018V1_EB_Full_ptbin3_mean_25ns'),
            connect = cms.string('frontier://FrontierProd/CMS_CONDITIONS')
            ),
        cms.PSet(
            record = cms.string('GBRDWrapperRcd'),
            tag = cms.string('ecalPFClusterCor2018V1_EB_ZS_sigma_25ns'),
            #label = cms.untracked.string('ecalPFClusterCor2018V1_EB_ZS_sigma_25ns'),
            connect = cms.string('frontier://FrontierProd/CMS_CONDITIONS')
            ),
        cms.PSet(
            record = cms.string('GBRDWrapperRcd'),
            tag = cms.string('ecalPFClusterCor2018V1_EB_Full_ptbin1_sigma_25ns'),
            #label = cms.untracked.string('ecalPFClusterCor2018V1_EB_Full_ptbin1_sigma_25ns'),
            connect = cms.string('frontier://FrontierProd/CMS_CONDITIONS')
            ),
        cms.PSet(
            record = cms.string('GBRDWrapperRcd'),
            tag = cms.string('ecalPFClusterCor2018V1_EB_Full_ptbin2_sigma_25ns'),
            #label = cms.untracked.string('ecalPFClusterCor2018V1_EB_Full_ptbin2_sigma_25ns'),
            connect = cms.string('frontier://FrontierProd/CMS_CONDITIONS')
            ),
        cms.PSet(
            record = cms.string('GBRDWrapperRcd'),
            tag = cms.string('ecalPFClusterCor2018V1_EB_Full_ptbin3_sigma_25ns'),
            #label = cms.untracked.string('ecalPFClusterCor2018V1_EB_Full_ptbin3_sigma_25ns'),
            connect = cms.string('frontier://FrontierProd/CMS_CONDITIONS')
            ),
        cms.PSet(
            record = cms.string('GBRDWrapperRcd'),
            tag = cms.string('ecalPFClusterCor2018V1_EE_ZS_mean_25ns'),
            #label = cms.untracked.string('ecalPFClusterCor2018V1_EE_ZS_mean_25ns'),
            connect = cms.string('frontier://FrontierProd/CMS_CONDITIONS')
            ),
        cms.PSet(
            record = cms.string('GBRDWrapperRcd'),
            tag = cms.string('ecalPFClusterCor2018V1_EE_Full_ptbin1_mean_25ns'),
            #label = cms.untracked.string('ecalPFClusterCor2018V1_EE_Full_ptbin1_mean_25ns'),
            connect = cms.string('frontier://FrontierProd/CMS_CONDITIONS')
            ),
        cms.PSet(
            record = cms.string('GBRDWrapperRcd'),
            tag = cms.string('ecalPFClusterCor2018V1_EE_Full_ptbin2_mean_25ns'),
            #label = cms.untracked.string('ecalPFClusterCor2018V1_EE_Full_ptbin2_mean_25ns'),
            connect = cms.string('frontier://FrontierProd/CMS_CONDITIONS')
            ),
        cms.PSet(
            record = cms.string('GBRDWrapperRcd'),
            tag = cms.string('ecalPFClusterCor2018V1_EE_Full_ptbin3_mean_25ns'),
            #label = cms.untracked.string('ecalPFClusterCor2018V1_EE_Full_ptbin3_mean_25ns'),
            connect = cms.string('frontier://FrontierProd/CMS_CONDITIONS')
            ),
        cms.PSet(
            record = cms.string('GBRDWrapperRcd'),
            tag = cms.string('ecalPFClusterCor2018V1_EE_ZS_sigma_25ns'),
            #label = cms.untracked.string('ecalPFClusterCor2018V1_EE_ZS_sigma_25ns'),
            connect = cms.string('frontier://FrontierProd/CMS_CONDITIONS')
            ),
        cms.PSet(
            record = cms.string('GBRDWrapperRcd'),
            tag = cms.string('ecalPFClusterCor2018V1_EE_Full_ptbin1_sigma_25ns'),
            #label = cms.untracked.string('ecalPFClusterCor2018V1_EE_Full_ptbin1_sigma_25ns'),
            connect = cms.string('frontier://FrontierProd/CMS_CONDITIONS')
            ),
        cms.PSet(
            record = cms.string('GBRDWrapperRcd'),
            tag = cms.string('ecalPFClusterCor2018V1_EE_Full_ptbin2_sigma_25ns'),
            #label = cms.untracked.string('ecalPFClusterCor2018V1_EE_Full_ptbin2_sigma_25ns'),
            connect = cms.string('frontier://FrontierProd/CMS_CONDITIONS')
            ),
        cms.PSet(
            record = cms.string('GBRDWrapperRcd'),
            tag = cms.string('ecalPFClusterCor2018V1_EE_Full_ptbin3_sigma_25ns'),
            #label = cms.untracked.string('ecalPFClusterCor2018V1_EE_Full_ptbin3_sigma_25ns'),
            connect = cms.string('frontier://FrontierProd/CMS_CONDITIONS')
            ),
        ))
