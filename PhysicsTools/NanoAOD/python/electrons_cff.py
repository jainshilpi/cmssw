...
for modifier in run2_miniAOD_80XLegacy,run2_nanoAOD_94XMiniAODv1,run2_nanoAOD_94XMiniAODv2,run2_nanoAOD_94X2016,run2_nanoAOD_102Xv1,run2_nanoAOD_106Xv1, run2_egamma_2017:
...
run2_nanoAOD_94X2016.toModify(isoForEle,
                                EAFile_MiniIso = "RecoEgamma/ElectronIdentification/data/Spring15/effAreaElectrons_cone03_pfNeuHadronsAndPhotons_25ns.txt",
                                EAFile_PFIso = "RecoEgamma/ElectronIdentification/data/Summer16/effAreaElectrons_cone03_pfNeuHadronsAndPhotons_80X.txt")
for modifier in run2_nanoAOD_94XMiniAODv1,run2_nanoAOD_94XMiniAODv2,run2_nanoAOD_94X2016,run2_nanoAOD_102Xv1,run2_nanoAOD_106Xv1, run2_egamma_2017:
...
run2_egamma_2017.toModify(calibratedPatElectrons106X, src = "slimmedElectronsUpdated")
...
run2_egamma_2017.toModify(slimmedElectronsWithUserData.userFloats,
    ecalTrkEnergyErrPostCorrNew = cms.InputTag("calibratedPatElectrons106X","ecalTrkEnergyErrPostCorr"),
    ecalTrkEnergyPreCorrNew     = cms.InputTag("calibratedPatElectrons106X","ecalTrkEnergyPreCorr"),
    ecalTrkEnergyPostCorrNew    = cms.InputTag("calibratedPatElectrons106X","ecalTrkEnergyPostCorr"),
)
...
#therefore we redo it but but we need use a new name for the userFloat as we cant override existing userfloats
#for technical reasons
for modifier in run2_nanoAOD_94XMiniAODv1,run2_nanoAOD_94XMiniAODv2,run2_miniAOD_80XLegacy,run2_nanoAOD_102Xv1, run2_egamma_2017:
    modifier.toModify(electronTable.variables,            
...
_withUpdateTo106X_sequence = electronSequence.copy()
_withUpdateTo106X_sequence.replace(slimmedElectronsWithUserData, calibratedPatElectrons106X + slimmedElectronsWithUserData)
_withUpdateTo106X_sequence.replace(bitmapVIDForEle, slimmedElectronsWithUserData + bitmapVIDForEle)
run2_egamma_2017.toReplaceWith(electronSequence, _withUpdate_sequence)
