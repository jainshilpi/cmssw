...
#process.VtxSmeared.MeanX  = 33.231449
#process.VtxSmeared.SigmaX = .798317
#process.VtxSmeared.MeanY  = 20.691128
#process.VtxSmeared.SigmaY = .66349
