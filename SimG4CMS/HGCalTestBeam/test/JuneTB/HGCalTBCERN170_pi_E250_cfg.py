...
process.generator = cms.EDProducer("FlatRandomEThetaGunProducer",
    ...
    PGunParameters = cms.PSet(
        MinE = cms.double(249.99),
        MaxE = cms.double(250.01),
...
process.VtxSmeared.MeanX  = .397
process.VtxSmeared.SigmaX = .680
process.VtxSmeared.MeanY  = -.507
process.VtxSmeared.SigmaY = .601
