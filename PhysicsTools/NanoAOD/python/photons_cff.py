...
for modifier in run2_miniAOD_80XLegacy,run2_nanoAOD_94X2016:
    modifier.toModify(calibratedPatPhotonsNano,
...
for modifier in run2_egamma_2016,run2_egamma_2017,run2_egamma_2018,run2_miniAOD_80XLegacy,run2_nanoAOD_94XMiniAODv1,run2_nanoAOD_94XMiniAODv2,run2_nanoAOD_102Xv1,run2_nanoAOD_94X2016:
...
for modifier in run2_egamma_2016,run2_egamma_2017,run2_egamma_2018,run2_nanoAOD_94XMiniAODv1, run2_miniAOD_80XLegacy, run2_nanoAOD_94X2016, run2_nanoAOD_102Xv1,run2_nanoAOD_94XMiniAODv2:
    modifier.toModify(photonTable.variables,
