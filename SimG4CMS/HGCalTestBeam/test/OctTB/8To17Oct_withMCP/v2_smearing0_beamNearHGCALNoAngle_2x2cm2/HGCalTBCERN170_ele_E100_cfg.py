...
#process.VtxSmeared.MeanX  = 33.391322
#process.VtxSmeared.SigmaX = .783124
#process.VtxSmeared.MeanY  = 20.771215
#process.VtxSmeared.SigmaY = .732903
